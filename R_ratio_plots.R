...
labs(x = "Date",y="Ratio of 5 Day Change in New Cases") + scale_x_date(date_breaks="1 week",date_labels = "%b %d") +
...
labs(x = "Date",y="Ratio of 7 Day Change in New Cases") + scale_x_date(date_breaks="1 week",date_labels = "%b %d") +
  theme(panel.grid.minor = element_blank(),panel.background = element_blank(),axis.line = element_line(colour = "black")) 
